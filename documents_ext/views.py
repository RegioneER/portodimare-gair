...
from geonode.documents.forms import DocumentCreateForm, DocumentReplaceForm
from documents_ext.forms import DocumentForm
...
ALLOWED_DOC_DATA_UPLOAD_MAX_MEMORY_SIZE = settings.DATA_UPLOAD_MAX_MEMORY_SIZE
...
class DocumentUploadView(CreateView):
    ...
    def get_context_data(self, **kwargs):
        ...
        context['DATA_UPLOAD_MAX_MEMORY_SIZE'] =  ALLOWED_DOC_DATA_UPLOAD_MAX_MEMORY_SIZE
        return context
...
def document_metadata(
    ...
    if document is None:
        ...
        #) and category_form.is_valid():
            ...
            new_domain_area = document_form.cleaned_data['domain_area']
            ...
            if new_domain_area:
                document.domain_area.clear()
                document.domain_area.add(*new_domain_area)
            
           # document.category = new_category
            document.category = document_form.cleaned_data['category'] 
            document.save()
