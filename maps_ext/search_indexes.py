...
class MapIndex(indexes.SearchIndex, indexes.Indexable):
    ...
    category__main_category__gn_description = indexes.CharField(model_attr="category__main_category__gn_description", null=True)
    data_portal__gn_description = indexes.CharField(model_attr="data_portal__gn_description", null=True)
    validation_level__gn_description = indexes.CharField(model_attr="validation_level__gn_description", null=True)
    data_accessibility = indexes.CharField(model_attr="data_accessibility", null=True)
    starred = indexes.BooleanField(model_attr="starred", null=True)
    ...
    category = indexes.CharField(
        ...
        null=True,
        stored=True)
    main_category = indexes.CharField(
        model_attr="category__main_category__identifier",
        faceted=True,
        null=True,
        stored=True)
    data_portal = indexes.CharField(
        model_attr="data_portal__identifier",
        faceted=True,
        null=True,
        stored=True)
    validation_level = indexes.CharField(
        model_attr="validation_level__identifier",
        faceted=True,
        null=True,
        stored=True)
    ...
    regions = indexes.MultiValueField(
        ...
        faceted=True,
        stored=True)
    domain_area = indexes.MultiValueField(
        model_attr="domain_area_identifier_list",
        null=True,
        faceted=True,
        stored=True)
    popular_count = indexes.IntegerField(
