...
from maps_ext.forms import MapForm
...
from geonode.maps.tasks import delete_map
...
def map_metadata(
   ...
   # ) and category_form.is_valid():
        ...
        new_domain_area = map_form.cleaned_data['domain_area']
        ...
        if new_domain_area:
            map_obj.domain_area.clear()
            map_obj.domain_area.add(*new_domain_area)
        #map_obj.category = new_category
        map_obj.category = map_form.cleaned_data['category'] 
        map_obj.save()
